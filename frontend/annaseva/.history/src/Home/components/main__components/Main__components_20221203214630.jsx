        ...
        <>
            <Index_Home>
                ...
                <div className="home-content">
                    ...
                    <div class="social">
                        <a className="button" href="https://www.facebook.com/ibcManit16"></a>
                        <a className="button" href="https://www.instagram.com/ibc_manit/"><i class="fab fa-instagram"></i></a>
                        <a className="button" href="https://www.linkedin.com/in/intellect-browsers-consortium-manit-378b001a7/"><i class="fab fa-linkedin"></i></a>
                        <a className="button" href="https://cognizanttrances.wordpress.com/"><i class="fab fa-wordpress"></i></a>
                    </div>
                </div>
            </Index_Home>
