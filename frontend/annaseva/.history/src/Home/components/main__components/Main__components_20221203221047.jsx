    ...
    <>
      <Index_Home>
        ...
        <div className="home-content">
          ...
          <span style={{display: "flex" , justifyContent: "space-around", textAlign: "center" , alignItems: "center"}}>
            
            <ThemeProvider theme={theme}>
            <Button variant='contained' color='neutral'>Btn1</Button>
            </ThemeProvider>
            <ThemeProvider theme={theme}>
            <Button variant='contained' color='neutral'>Btn2</Button>
            </ThemeProvider>
          </span>
