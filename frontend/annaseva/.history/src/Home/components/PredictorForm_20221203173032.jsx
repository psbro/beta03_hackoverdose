...
export default function PredictorForm() {
    ...
    <form className="row g-3">
      <div className="col-12">
        ...
        <input type="text" className="form-control" id="centre_id"/>
          </div>
          <div className="col-12">
        <label for="meal_id" className="form-label">Meal Id</label>
        <input type="text" className="form-control" id="meal_id"/>
          </div>
          <div className="col-12">
        <label for="checkout_price" className="form-label">Net price of the item</label>
        <input type="text" className="form-control" id="checkout_price"/>
          </div>
          <div className="col-12">
        <label for="base_price" className="form-label">Original price of the item</label>
        <input type="text" className="form-control" id="base_price"/>
          </div>
        <label htmlFor="emailer_for_promotion">Did you send promotional emails for this item?</label>
          <select id="emailer_for_promotion" class="form-select" aria-label="Default select example">
            <option selected>Yes</option>
            <option value="No">No</option>
          </select>
          <label htmlFor="homepage_featured">Is this item present on your website homepage?</label>
          <select id="homepage_featured" class="form-select" aria-label="Default select example">
            <option selected>Yes</option>
            <option value="No">No</option>
          </select>
          <div>
              <Button component={Link} variant="contained" to="#">Submit</Button>
          </div>
      </form>
        </div>
  )
