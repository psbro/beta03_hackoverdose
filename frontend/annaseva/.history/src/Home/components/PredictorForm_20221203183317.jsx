...
export default function PredictorForm() {
  ...
  const handleapi = async(e) => {
    ...
    let info = await axios.post(`https://predictor.devanshkapri2.repl.co/predict`, data).then((val) => {
      ...
      console.log(Math.ceil()val.data)
    ...
    setpredictState.centre_id(null)
    setpredictState.meal_id(null)
    setpredictState.checkout_price(null)
    setpredictState.base_price(null)
    setpredictState.email_for_promotion("Yes")
    setpredictState.homepage_featured("Yes")
