...
export default function PredictorForm() {
  ...
  const handleapi = async () => {
    ...
    let data = [centre_id: predictState.centre_id,
      meal_id: predictState.meal_id, predictState.checkout_price, predictState.base_price, data1, data2]

    

    let info = await axios.post(`https://predictor.devanshkapri2.repl.co/predict`, data).then((data) => {
