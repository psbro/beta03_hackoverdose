...
export default function PredictorForm() {
  ...
  const [predictState, setpredictState] = useState({
    ...
    checkout_price: null,
    base_price: null,
    email_for_promotion: null,
    homepage_featured: null,
...
const handleapi = async () => {
    ...
    <form className="row g-3">
      <div className="col-12">
        ...
        <input type="text" className="form-control" id="centre_id" name='centre_id' value={predictState.centre_id}/>
          </div>
          <div className="col-12">
        <label for="meal_id" className="form-label">Meal Id</label>
        <input type="text" className="form-control" id="meal_id" name='meal_id' value={predictState.meal_id}/>
          </div>
          <div className="col-12">
        <label for="checkout_price" className="form-label">Net price of the item</label>
        <input type="text" className="form-control" id="checkout_price" name='checkout_price' value={predictState.checkout_price}/>
          </div>
          <div className="col-12">
        <label for="base_price" className="form-label">Original price of the item</label>
        <input type="text" className="form-control" id="base_price" name='base_price' value={predictState.base_price}/>
          </div>
        <label htmlFor="emailer_for_promotion">Did you send promotional emails for this item?</label>
          <select id="emailer_for_promotion" class="form-select" aria-label="Default select example" name='email_for_promotion' value={predictState.email_for_promotion}>
            <option selected value="ye">Yes</option>
