      ...
      <Events>
        ...
        <All_events>
          <div className="event" data-aos="fade-up">
            <img src={photo4} alt="event" className="event-img" />
            <h3 className="sub-heading">Food is Donated</h3>
          ...
          <div className="event" data-aos="fade-up">
            <img src={photo5} alt="event" className="event-img" />
            <h3 className="sub-heading">FOOD IS SECURED</h3>
            <p className="event-desc">
          ...
          <div className="event" data-aos="fade-up">
            <img src={photo6} alt="event" className="event-img" />
            <h3 className="sub-heading">FOOD IS PICKED UP</h3>
            <p className="event-desc">
